    ...
    'User': {
        ...
        'Init': function () {
            ...
            if (MAC.Cookie.Get('user_id') != undefined && MAC.Cookie.Get('user_id') != '') {
                ...
                if ($('.mac_user').length > 0) {
                    var Portrait = MAC.User.Portrait ? MAC.User.Portrait : `${maccms.path}/static/images/home/user_default.png`
                    var html = `
                    <div class="mac_drop_box mac_user_box" style="display: none;">
                        <ul class="logged">
                            ...
                            <li  class="user-item">
                                <img src="${maccms.path}/static/images/home/user.png" />
                                <a target="_blank" href="${url}">用户中心</a>
                            </li>
                            <li class="user-item">
                                <img src="${maccms.path}/static/images/home/quit.png" class="mac_portrait" />
                    ...
                    <div class="mac_drop_box mac_user_box" style="display: none;">
                        <ul class="logged">
                            <li class="login-item" onclick="MAC.User.Login()">
                                <div class="login-img">
                                    <img src="${maccms.path}/static/images/home/user_default.png" class="mac_portrait" />
                                </div>
                                <span>登录/注册</span>
