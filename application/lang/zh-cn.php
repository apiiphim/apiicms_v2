...
图1$upload/test.jpg
图2$https://img.phimcms.com.com/logo.png
https://img.phimcms.com.com/123.jpg
    ...
    'admin/public/head/title'=>'安全第一请勿泄露后台地址 - Copyright by Phim-CMS内容管理系统',
    'admin/public/jump/title'=>'跳转提示',

    'admin/index/login/title'=>'后台管理中心 - Copyright by Phim-CMS内容管理系统',
    'admin/index/login/tip_welcome'=>'欢迎使用Phim-CMS建站',
    ...
    'install/title'=>'Phim-CMS系统安装',
    'install/header'=>'感谢您选择!',
    'install/header1'=>'Phim-CMS系统建站',
    'install/lang'=>'语言包[langs]',
    'install/select_lang'=>'请选择语言包[select lang]',
    'install/lang_tip'=>'请根据自己身需要选择后台语言包',

    'install/user_agreement_title'=>'Phim-CMS用户协议 适用于所有用户',
    'install/user_agreement'=>' 请您在使用(Phim-CMS)前仔细阅读如下条款。包括免除或者限制作者责任的免责条款及对用户的权利限制。您的安装使用行为将视为对本《用户许可协议》的接受，并同意接受本《用户许可协议》各项条款的约束。 <br /><br />
                一、安装和使用： <br />
                (Phim-CMS)是免费和开源提供给您使用的，您可安装无限制数量副本。 您必须保证在不进行非法活动，不违反所在国家相关政策法规的前提下使用本软件。 <br /><br />
                二、免责声明：  <br />
                ...
                三、协议规定的约束和限制：  <br />
                禁止去除(Phim-CMS)源码里的版权信息，商业授权版本可去除后台界面及前台界面的相关版权信息。</br>
                禁止在(Phim-CMS)整体或任何部分基础上发展任何派生版本、修改版本或第三方版本用于重新分发。</br></br>
                <strong>版权所有 (c) 2020，Phim-CMS,保留所有权利</strong>。',
    ...
    'install/is_ok'=>'系统安装成功，欢迎您使用Phim-CMS建站',
    'install/os'=>'操作系统',
    'install/php'=>'php版本',
    'install/gd'=>'GD库',
    ...
    'admin/index/index/menu_refresh'=>'刷新页面',
];
